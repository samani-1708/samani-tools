...
import { splitPdfSeoConfig } from "./seo-config";
import { ToolContainer } from "@/app/common/tool-container";
import { createMetadataFromSchema } from "@/app/common/seo-page-schema";

export const metadata: Metadata = createMetadataFromSchema(splitPdfSeoConfig.schema);
...
export default function Page() {
  return (
    <>
      ...
      <PdfToolSeo config={splitPdfSeoConfig} />
    </>
  );
}
