...
import { lockPdfSeoConfig } from "./seo-config";
import { ToolContainer } from "@/app/common/tool-container";
import { createMetadataFromSchema } from "@/app/common/seo-page-schema";

export const metadata: Metadata = createMetadataFromSchema(lockPdfSeoConfig.schema);
...
export default function LockPdfPage() {
  return (
    <>
      ...
      <PdfToolSeo config={lockPdfSeoConfig} />
    </>
  );
}
