...
export const metadata: Metadata = createMetadata({
  ...
  description: `Read the ${SITE_NAME} privacy policy. Learn how files are processed in-browser and what data we do or do not collect.`,
  path: "/privacy",
  ...
  return (
    <div className="container max-w-4xl mx-auto px-4 md:px-6 py-12 space-y-6">
      ...
      <p className="text-muted-foreground">
        {SITE_NAME} prioritizes privacy. Wherever possible, file processing is
