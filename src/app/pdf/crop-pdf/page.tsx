...
import { cropPdfSeoConfig } from "./seo-config";
import { ToolContainer } from "@/app/common/tool-container";
import { createMetadataFromSchema } from "@/app/common/seo-page-schema";

export const metadata: Metadata = createMetadataFromSchema(cropPdfSeoConfig.schema);
...
export default function CropPdfPage() {
  return (
    <>
      ...
      <PdfToolSeo config={cropPdfSeoConfig} />
    </>
  );
}
